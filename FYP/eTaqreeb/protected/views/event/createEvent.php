        ...
        <div class="row">
          <div class="col-md-7">
            <div class="p-40" data-bg-color="rgba(255,255,255,0.8)">
              ...
              <h4 class="text-uppercase mb-5">Create Event!</h4>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                     ...
                     <?php
                          ...
                          echo $form->dropDownList($model,'shift',$types,['id'=>'type', 'class'=>'form-control']); ?>
 ...
 <div class="col-sm-12">
                   <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <?php echo $form->textField($model,'budget',['class'=>'form-control','placeholder'=>'Enter Budget', 'maxlength'=>'20','id'=>'budget']); ?>
            ...
            <div class="col-sm-12">
                ...
                <button data-loading-text="Please wait..." class="btn btn-colored btn-orange pl-30 pr-30" type="button" onclick="createEventAJAX()" >Create</button>
