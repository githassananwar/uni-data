        ...
        <div class="row">
          <div class="col-md-7">
            <div class="p-40" data-bg-color="rgba(255,255,255,0.8)">
              <h4 class="text-uppercase mb-5">Sign Up!</h4>
          ...
          <div class="col-sm-12">
            ...
            <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <?php echo $form->fileField($model,'image',['id'=>'vendorImage','class'=>'form-control','placeholder'=>'Image']); ?>
                      <span id="vendorImage_err" style="color:red;"></span>
                    </div>
                  </div>
</div>
            ...
            <div class="col-sm-12">
                 <div class="form-group">
                  <button data-loading-text="Please wait..." class="btn btn-colored btn-orange pl-30 pr-30" type="button" type="button" onclick="SignupAJAX()" id="add_vendor">Sign up</button>
                </div>
                </div>
