        ...
        <div class="row">
          ...
          <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <?php echo $form->textField($model,'username',['class'=>'form-control','placeholder'=>'Enter Username', 'id'=>'username', 'maxlength'=>'100', 'onblur'=>"updateUserNameAJAX($model->id,'customer')"]); ?>
          ...
          <div class="col-sm-6">
                 ...
                 <div class="col-sm-6">
                 <div class="form-group">
                    <button data-loading-text="Please wait..." class="btn btn-colored btn-orange pl-30 pr-30" type="button" onclick="updateCustomerAJAX()" id="add_customer" >Update</button>
                  </div>
                  </div>
                  </div>
