        ...
        <div class="row">
          <div class="col-md-7">
            <div class="p-40" data-bg-color="rgba(255,255,255,0.8)">
              <h4 class="text-uppercase mb-5">Update Service!</h4>
...
<div class="col-sm-12">
          ...
          <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="col-sm-6">
                  <button data-loading-text="Please wait..." class="btn btn-colored btn-orange pl-30 pr-30" type="button" onclick="updateServiceAJAX()" >Update</button>
                </div>
                </div>
