...
int strLen(const char*); //returns length of string including place of null character
...
int CharString::FindSubstring(const char* str, int start) const
{
	...
	len=strLen(str)-1; //minus 1 - length of str excluding null char place.
...
void CharString::concat(const char* str)
{
	...
	nSize=strLen(str)-1; //excluding place of null char
