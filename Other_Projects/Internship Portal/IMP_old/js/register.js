...
function addInfoAJAX()
{
    ...
    $.ajax({
            ...
            data:{name:name,username:username, nsuid:nsuid, phoneno:phoneno, major:major, agencyName:agencyName, agencyAddress:agencyAddress, agencyWebsite:agencyWebsite, supervisorName:supervisorName, supervisorEmail:supervisorEmail, supervisorphoneNo:supervisorphoneNo, term:term},
            cache:false,
            success: function(result){
                var res = trimResult(result);
                if(result == "add"){
